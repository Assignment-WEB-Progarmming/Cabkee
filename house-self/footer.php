...
<html lang="vi">
    ...
    <body>
      <!-- Footer -->
      <footer class="page-footer font-small blue-grey lighten-5 style-footer" style="background-image:url(/Herios/images/background.jpg);background-repeat: no-repeat; background-size: cover; background-position: center center; margin-top:2cm">
        ...
        <div class="container text-center text-md-left mt-5 style-footer" style="font-family: 'quicksand';"> 
          ...
          <div class="row mt-3 dark-grey-text">
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mb-4">
              ...
              <!-- Content -->
              <img src="/house-self/custom/images/logo-nobrand.png" alt="" class="footer-icon-img">
