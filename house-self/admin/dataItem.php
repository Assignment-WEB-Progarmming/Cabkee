...
$product = executeResult('select * from db_product');
?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>Admin - Database Items</title>
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="comment.php">Purchase Order</a>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    foreach ($product as $item) {
                        $x = '' . $item['thumbnail'] . '';
                        $x = str_replace('../house-self/', '../', $x);
                        echo
                        '<tr>
                            <th scope="row">' . $item['id'] . '</th>
                            <td>' . $item['title'] . '</td>
                            <td><img src="' . $x . '" alt="" class="pic"></td>
                            <td>' . $item['price'] . '</td>
                            <td>' . $item['rate'] . '</td>
                            <td>' . $item['category'] . '</td>
